...
#define GREEN         	 0x07E0
#define CYAN          	 0x7FFF
#define YELLOW_ORIGIN    0xFFE0 //自带的黄色
#define YELLOW			 0XFCC0 //相中的黄色 rgb888=0xffd100   v1.0 0XFE80  v2.0 0XFE60
#define ORANGE			 0XE346	//橙色
#define BROWN 			 0XBC40 //棕色
#define BRRED 			 0XFC07 //棕红色
#define GRAY  			 0X8430 //灰色		//边框被选中的颜色
#define DIM					 0X2104	//暗灰 或者0X3186 边框未被选择时的颜色
#define POOR         0X5ACB	//背光		显示用户信息的背光色
...
u16  LCD_Fast_ReadPoint(u16 x,u16 y);									//针对NT35510独配的读点函数
void LCD_Draw_Circle(u16 x0,u16 y0,u8 r);						 			//画圆
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2);							//画线
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2);		   				//画矩形
void LCD_DrawBorder(u16 sx,u16 sy,u16 ex,u16 ey,u8 strokeWidth ,u16 color);//画边框
void LCD_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);		   				//填充单色
void LCD_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color);				//填充指定颜色
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode);						//显示一个字符
void LCD_ShowChar_Ex(u16 x,u16 y,u8 num,u8 size,u8 mode);					//显示任意大小的字符
void LCD_ShowChar_RTC(u16 x,u16 y,u8 num,u8 size,u8 mode);				//RTC专供
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);				//显示 数字
void LCD_ShowxNum_RTC(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);			//显示RTC形式的数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p);		//显示一个字符串,12/16字体
void LCD_ShowStringFloat(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p);//用叠加显示的方式显示字符串
