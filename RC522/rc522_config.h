...
//时钟，即RC522模块的SCK引脚,接STM32的SPI的SCK引脚(PA5)
...
// 数据输入，即即RC522模块的MOSI引脚，接STM32的SPI的MOSI引脚(PA7)
...
// 数据输出，即即RC522模块的MISO引脚，接STM32的SPI的MISO引脚(PA6)
...
//复位，即即RC522模块的RST引脚，接STM32的普通IO即可(PF8)
